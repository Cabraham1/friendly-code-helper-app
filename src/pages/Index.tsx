...
const Index = () => {
  ...
  const weatherData = [
    { label: "Temperature", value: "33°C", icon: Thermometer, trend: "+2°C", location: "Partly cloudy" },
    { label: "Air Quality", value: "78", icon: Wind, trend: "Good", location: "AQI Moderate" },
    { label: "Wind Speed", value: "12 km/h", icon: Wind, trend: "Low", location: "Wind" },
    { label: "UV Index", value: "High", icon: Eye, trend: "8/10", location: "UV Light protection recommended" },
    { label: "Humidity", value: "72%", icon: CloudRain, trend: "Normal", location: "Humidity" },
    { label: "Precipitation", value: "10%", icon: CloudRain, trend: "Low", location: "Precipitation" },
  ];

  const learningModules = [
    {
      title: "Energy & Emissions",
      description: "Understanding carbon footprints and renewable energy solutions",
      image: "https://images.unsplash.com/photo-1497436072909-f5e4be442838?w=300&h=200&fit=crop",
      duration: "45 min",
      level: "Beginner"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 p-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 text-white/80">
            ...
            <a href="#" className="hover:text-white transition-colors">Live Data</a>
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900/50 to-slate-900/50 bg-[url('https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1920&h=1080&fit=crop')] bg-cover bg-center bg-blend-overlay">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto animate-fade-in">
            Real-time climate insights and interactive learning to spark awareness, action and change across Africa.
          </p>
            ...
            {[
              ...
              <Card key={index} className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-white/80">Read More → {stat.reads}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Track Climate Changes Live</h2>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-100">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Global Climate Map</h3>
              <p className="text-gray-600 mb-6">
                Interactive visualization of real-time climate data across Africa and beyond.
              </p>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Learn by playing</h2>
              <p className="text-xl text-gray-600 mb-8">
                Explore quizzes and challenges designed to teach you about climate change while having fun.
              </p>
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-700">Challenge your friends and classmates</span>
                </li>
              </ul>
              <Button className="bg-blue-500 hover:bg-blue-600">
                Start Playing
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-cyan-600 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Join a Growing Climate Action Community</h2>
              <p className="text-xl text-blue-100 mb-8">
                Connect with like-minded individuals, join discussions, share local solutions, and participate in real-world challenges that make an impact.
              </p>
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                ...
                <p className="text-center text-blue-100">Join thousands of climate advocates making a difference</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Sign up for a personalized learning experience. Track your progress, unlock achievements, and explore climate topics.
          </p>
          <Button size="lg" className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4">
            Create an account
          </Button>
